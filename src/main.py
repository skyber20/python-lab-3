...
from src.funcs.sorts.bucket import bucket_sort
...
def main() -> None:
    ...
    print(bubble_sort([5, 2, 8, 2, 1], cmp=lambda x, y: x < y))
    print(bubble_sort(['ws', 'qede2', '2ed2d2dd2ed', 'sde', '3efes'], key=len, cmp=lambda x, y: x < y))
    ...
    print(bucket_sort([9.3, -3.6, -3.5, -3, 10, 12.1, -100]), end='\n\n')
